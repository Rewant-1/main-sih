...
export default function RecentActivityWidget({ alumni = [] }: RecentActivityWidgetProps) {
  ...
  const activities: Activity[] = React.useMemo(() => {
    ...
    const sortedAlumni = [...alumni]
      .filter((a) => (a as any).createdAt || (a as any).updatedAt)
      .sort((a, b) => {
    ...
    return sortedAlumni.map((a, index) => {
      ...
      const date = new Date((a as any).updatedAt || (a as any).createdAt || Date.now());
