  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.debug('Admin login - userType:', loggedUser?.userType, 'role:', loggedUser?.role, 'isAdmin:', loggedUser?.isAdmin);
      ...
      const userType = ((loggedUser?.userType ?? loggedUser?.role ?? payloadUserType ?? "")).toLowerCase();
      const isAdminFlag = loggedUser?.isAdmin === true;
