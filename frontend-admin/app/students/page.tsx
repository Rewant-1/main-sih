...
export default function StudentsPage() {
  ...
  const filteredStudents = students.filter((s) => {
    const user = s.userId as { name?: string; email?: string } | undefined;
                ...
                <TableBody>
                  {isLoading ? (
                    ...
                    filteredStudents.map((student) => {
                      const user = student.userId as { name?: string; email?: string } | undefined;
                      return (
            ...
            {selectedStudent && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm">
                    {(selectedStudent.userId as { name?: string })?.name || "N/A"}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-sm">
                    {(selectedStudent.userId as { email?: string })?.email || "N/A"}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">
