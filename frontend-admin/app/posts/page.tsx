        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {isLoading ? (
            ...
            filteredPosts.map((post) => {
              const author = post.postedBy as User | undefined;
              return (
            ...
            {selectedPost && (
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Avatar className="h-10 w-10">
                    <AvatarFallback>
                      {(selectedPost.postedBy as User)?.name?.charAt(0) || "U"}
                    </AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="font-medium">
                      {(selectedPost.postedBy as User)?.name || "Unknown User"}
                    </p>
                    <p className="text-xs text-muted-foreground">
                          ...
                          <div key={i} className="flex gap-2 p-2 rounded-lg bg-muted">
                            <Avatar className="h-6 w-6">
                              <AvatarFallback className="text-xs">
                                {(comment.user as User)?.name?.charAt(0) || "U"}
                              </AvatarFallback>
                            </Avatar>
                            <div className="flex-1">
                              <div className="flex items-center gap-2">
                                <p className="text-xs font-medium">
                                  {(comment.user as User)?.name || "Unknown"}
                                </p>
